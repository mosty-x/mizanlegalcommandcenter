...
export function LegalShell({ children, userName }: { children: React.ReactNode; userName: string }) {
  ...
  const nav = [
    ...
    { href: "/specialize", label: "تطوير التخصص والمراجعة", icon: Settings2 },
    { href: "/knowledge", label: "الذاكرة القانونية المصرية", icon: BookOpen },
      ...
      <aside className={cn("side-panel", open && "is-open")}>
        ...
        <div className="side-footer">
          ...
          <div className="user-line">
            ...
            <div><strong>{userName}</strong><small>مساحة العمل</small></div>
