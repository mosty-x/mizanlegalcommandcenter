...
function initialize(database: DatabaseSync): void {
  database.exec(`
    ...
    CREATE TABLE IF NOT EXISTS legal_units (user_id TEXT NOT NULL, id TEXT NOT NULL, ciphertext TEXT NOT NULL, iv TEXT NOT NULL, content_hash TEXT NOT NULL, PRIMARY KEY(user_id,id));
    CREATE TABLE IF NOT EXISTS rag_cache (user_id TEXT NOT NULL, cache_key TEXT NOT NULL, ciphertext TEXT NOT NULL, iv TEXT NOT NULL, expires_at INTEGER NOT NULL, PRIMARY KEY(user_id,cache_key));
    CREATE TABLE IF NOT EXISTS rag_nodes (user_id TEXT NOT NULL, run_id TEXT NOT NULL, node_id TEXT NOT NULL, event_json TEXT NOT NULL, PRIMARY KEY(user_id,run_id,node_id));
    CREATE TABLE IF NOT EXISTS rag_profiles (user_id TEXT NOT NULL, tool_slug TEXT NOT NULL, revision INTEGER NOT NULL, ciphertext TEXT NOT NULL, iv TEXT NOT NULL, content_hash TEXT NOT NULL, created_at TEXT NOT NULL, PRIMARY KEY(user_id,tool_slug,revision));
    CREATE INDEX IF NOT EXISTS idx_rag_cache_expiry ON rag_cache(expires_at);
  `);
}
